...
class StaffProfileAdmin(ExportActionMixin, ImportMixin, OrderableAdmin, VersionAdmin):
    ...
    # for import-export
    resource_class = None  # override して設定してください
    formats = [base_formats.CSV, base_formats.JSON]  # yamlも使いたいがバグってるので、今回は無効とする

    # for buttons
    change_list_template = "admin/stafflist/change_list.html"
